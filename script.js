...
// Add booking functionality (basic example)
document.addEventListener('DOMContentLoaded', () => {
    const bookingButtons = document.querySelectorAll('.room-card');
    
    bookingButtons.forEach(card => {
        ...
        button.addEventListener('click', () => {
            ...
            showBookingModal(roomTitle);
        });
        
        card.querySelector('.room-content').appendChild(button);
    });
});
...
function showBookingModal(roomType) {
    ...
    modal.innerHTML = `
        <h3 style="color: #2c5530; margin-bottom: 1rem;">Book ${roomType}</h3>
        <p style="color: #666; margin-bottom: 2rem;">Please contact us to complete your booking:</p>
        <div style="margin-bottom: 1rem;">
            <strong>Phone:</strong> +591 3-892-XXXX
        </div>
        <div style="margin-bottom: 1rem;">
            <strong>Email:</strong> info@elcurichalhostel.com
        </div>
        <div style="margin-bottom: 2rem;">
            <strong>WhatsApp:</strong> Available 24/7
        </div>
        <button id="closeModal" class="btn btn-primary" style="width: 100%;">Close</button>
    `;
